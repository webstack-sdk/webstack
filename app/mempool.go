...
func (app *WebstackApp) configureEVMMempool(appOpts servertypes.AppOptions, logger log.Logger) error {
...
func (app *WebstackApp) createMempoolConfig(appOpts servertypes.AppOptions, logger log.Logger) (*evmmempool.EVMMempoolConfig, error) {
