...
// LicenseParamsOutput mirrors the Solidity LicenseParams tuple (output side).
type LicenseParamsOutput struct {
...
func licenseToOutput(l licensetypes.License) (LicenseOutput, error) {
...
func licensesToOutputs(ls []licensetypes.License) ([]LicenseOutput, error) {
...
// counterparts, propagating the first decode error.
func addressPermissionsListToOutputs(aks []licensetypes.AddressPermissions) ([]AddressPermissionsOutput, error) {
...
func addressPermissionsToOutput(ak licensetypes.AddressPermissions) (AddressPermissionsOutput, error) {
